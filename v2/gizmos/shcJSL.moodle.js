...
MOODLE.modal = $Moodle = function(element, options) {
	...
	defaults = {
		...
		type: 'POST',
		target: (ajaxdata !== undefined && ajaxdata.ajaxurl !== undefined)? ajaxdata.ajaxurl:false
	}
	...
	this.update = function(element, options) {	
		 ...
		 */ 
		elementOptions = (shcJSL.options(element.getAttribute("shc:stamp")))? (shcJSL.options(element.getAttribute("shc:stamp")).moodle)? shcJSL.options(element.getAttribute("shc:stamp")).moodle:{}:{};
...
/**
	 ...
	 * @since 1.0
	 */
if (Machina && Machina.Gizmos)  {
	Machina.Gizmos.moodle = function(elements) {
